...
const addBasepathAndRegex = createNodeMiddleware(({ file }) => {
  let {url, basepath, regex} = folderUrl(file.path);
  console.log({fileURL: url, basepath, regex});
...
module.exports = { addPath, addBasepathAndRegex, addId, removeUnderscoredDirs, removeNonSvelteFiles, defineFiles }
